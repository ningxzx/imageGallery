...
module.exports = {"name":"imagegallery","version":"1.0.0","description":"My astonishing Nuxt.js project","author":"zhenxing.xiang","private":true,"scripts":{"dev":"cross-env NODE_ENV=development nodemon server/index.js --exec backpack --watch server","test":"mocha","build":"nuxt build && backpack build","start":"cross-env NODE_ENV=production node build/main.js","generate":"nuxt generate","lint":"eslint --ext .js,.vue --ignore-path .gitignore .","precommit":"npm run lint"},"dependencies":{"@nuxtjs/axios":"^5.0.0","consola":"^2.2.6","cross-env":"^5.2.0","element-ui":"^2.4.6","koa":"^2.5.2","koa-bodyparser":"^4.2.1","koa-connect":"^2.0.1","koa-mount":"^4.0.0","koa-static":"^5.0.0","koa-trie-router":"^2.1.6","less":"^3.8.1","less-loader":"^4.1.0","nuxt":"^2.2.0","ramda":"^0.25.0"},"devDependencies":{"babel-cli":"^6.26.0","babel-core":"^6.26.3","babel-eslint":"^8.2.1","babel-preset-env":"^1.7.0","backpack-core":"^0.8.2","eslint":"^5.0.1","eslint-loader":"^2.0.0","eslint-plugin-vue":"^4.0.0","mocha":"^5.2.0","nodemon":"^1.11.0"}};
